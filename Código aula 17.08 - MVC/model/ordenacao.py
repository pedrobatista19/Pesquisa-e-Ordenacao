class Ordenacao:
    ...
    @staticmethod
    def quicksort_completo(lista):
        """Zera os contadores de classe, roda o quicksort e devolve
        comparações/trocas dessa execução (evita acumular entre chamadas)."""
        Ordenacao.qtd_comparacoes = 0
        Ordenacao.qtd_trocas = 0
        Ordenacao.quicksort(lista, 0, len(lista) - 1)
        return Ordenacao.qtd_comparacoes, Ordenacao.qtd_trocas